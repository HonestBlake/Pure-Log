...
// #DIV: Public Methods
    ...
    template<class T_Derived, bool t_usingLevelFormatting, bool t_usingColors> 
    T_Derived& Logger<T_Derived, t_usingLevelFormatting, t_usingColors>::time(const TimePoint& p_time){
        if(m_bufferedLog){
...
// #DIV: Protected Methods
    ...
    // #FUNCTION: getFormattedTime(const std::variant<Log::Level, std::string>&, const TimePoint&), Method
    template<class T_Derived, bool t_usingLevelFormatting, bool t_usingColors>
    std::string Logger<T_Derived, t_usingLevelFormatting, t_usingColors>::getFormattedTime(const std::variant<Log::Level, std::string>& p_level, const TimePoint& p_time){
        // Convert time
    ...
    } // #END: getFormattedTime(const std::variant<Log::Level, std::string>&, const TimePoint&)
